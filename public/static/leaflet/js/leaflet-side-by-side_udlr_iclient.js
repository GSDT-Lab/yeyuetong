  ...
  remove: function () {
    ...
    if (this._leftLayers) {
      ...
      for (var i = 0; i < leftlayernum; i++) {
        (this._leftLayers[i].getContainer ? this._leftLayers[i].getContainer() : this._leftLayers[i].getPane()).style.clip = ''
      }
    ...
    if (this._rightLayers) {
      ...
      for (var i = 0; i < rightlayernum; i++) {
        (this._rightLayers[i].getContainer ? this._rightLayers[i].getContainer() : this._rightLayers[i].getPane()).style.clip = ''
      }
    }
