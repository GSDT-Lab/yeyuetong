<template>
    ...
    <!-- 编辑可视域控件 -->
    <div id="wrapper" style="display: none;" class="edit-wrapper">
      <div id="login" class="edit-panel">
    ...
    <!-- 视频播放器 -->
    <div id="video" class="video-player" style="display: none">
      <div class="video-header">
        <span class="video-title">监控视频</span>
        <div class="video-controls">
          <span class="close-video" @click="closeVideo">×</span>
          <span class="fullscreen-btn" @click="toggleFullScreen">⛶</span>
        </div>
      </div>
      <video 
        id="trailer" 
        ...
        loop 
        crossorigin=""
        src="http://localhost:8090/video/2.mp4"
      >
        您的浏览器不支持视频播放
      </video>
    </div>
    ...
    <!-- 摄像头编辑控件 -->
    <div id="camerawrapper" style="display: none" class="camera-wrapper">
      <div id="login" class="camera-panel">
        <div class="camera-header">
          <h3>摄像头属性编辑</h3>
          <span class="close-btn" aria-hidden="true">×</span>
        </div>
        <form class="camera-form">
          <div class="form-group">
            <label>方向(度)</label>
            <div class="input-group">
              <input 
  ...
  import { OfficeBuilding, VideoCamera, View, Close, Delete, Search, Light } from '@element-plus/icons-vue'
  ...
  var viewer;
  var grain_model = "http://127.0.0.1:8090/model/meishiyitiaojie.glb";
  var camera = "http://127.0.0.1:8090/newmodel/camera.glb";
  var light = "http://127.0.0.1:8090/model/light.glb";
  let tableData = [];
  var bar;
